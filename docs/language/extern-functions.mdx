...
Pure Datalog can't do everything. When you need custom logic — hashing, string parsing, external lookups — <StyledFlowLog /> lets you call into Rust code via **user-defined functions (UDFs)**.
